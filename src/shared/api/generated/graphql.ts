...
export type GetBookByIdQuery = { book: { title: string | null, author: { firstName: string | null, lastName: string | null } | null, genre: Array<{ id: string, name: string | null }> | null, reviews: Array<{ id: string, text: string | null, score: number | null, createdAt: unknown, user: { id: string, name: string | null } | null }> | null } | null };
